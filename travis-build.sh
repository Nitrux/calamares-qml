...
wget -qO /etc/apt/sources.list.d/ubuntu-bionic-repo.list https://raw.githubusercontent.com/Nitrux/nitrux-iso-tool/development/configs/files/sources.list.ubuntu.bionic
