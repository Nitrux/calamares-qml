...
QT_MOC_LITERAL(3, 26, 19), // "currentIndexChanged"
QT_MOC_LITERAL(4, 46, 5), // "count"
QT_MOC_LITERAL(5, 52, 12) // "currentIndex"

    },
    "DeviceModel\0countChanged\0\0currentIndexChanged\0"
    "count\0currentIndex"
};
...
void DeviceModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeviceModel::countChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DeviceModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeviceModel::currentIndexChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DeviceModel::countChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DeviceModel::currentIndexChanged()
{
