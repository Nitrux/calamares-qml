...
QT_MOC_LITERAL(3, 37, 8), // "newIndex"
QT_MOC_LITERAL(4, 46, 12) // "currentIndex"

    },
    "BootLoaderModel\0currentIndexChanged\0"
    "\0newIndex\0currentIndex"
};
...
void BootLoaderModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BootLoaderModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BootLoaderModel::currentIndexChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BootLoaderModel::currentIndexChanged(int _t1)
{
